...
export default function AddModal() {
    ...
    // Render vacations after apply changes 
    if(navigate){
    ...
    return (
        <div>
            <Tooltip title="Add" aria-label="add" placement="right-end">
                <Fab style={{ position: 'fixed', bottom: '10px', right: '10px', backgroundColor: '#33ab9f'}}>
            ...
            >
                <Fade in={open}>
                    ...
                    <form className="edit-form" onSubmit={add}>
                        <label htmlFor="destination">Destination:</label>
                            <input type="text" placeholder="Enter Destination" onChange={e => setDestination(e.target.value)}/>
                            <label htmlFor="description">Description:</label>
                            <input type="textarea" placeholder="Enter Description" onChange={e => setDescription(e.target.value)}/>
                            ...
                            <Button type="submit" variant="outlined" color="primary" style={{ backgroundColor: '33ab9f', marginTop: '10px' }}>
                                Add Vacation
                            </Button>
                        </form>
                    </div>
